...
namespace Ассоциации
{
    class Program
    {
        ...
        {
            // Общий товар
            Item cherry = new Item("Article_10", "Cherry", 26.9);

            // Кол-во
            OrderLine ordl_cherry = new OrderLine(7, cherry); 
            //// 
            ...
            Order ord1 = new Order(1, create_date, "Prititskogo", true, Matvey, ordl, ordl_cherry);
